...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = hdmi_ctl_iic
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = v_frmbuf_wr
 PARAMETER DRIVER_VER = 4.0
 PARAMETER HW_INSTANCE = hdmi_input_v_frmbuf_wr_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = v_hdmirxss
 PARAMETER DRIVER_VER = 5.2
 PARAMETER HW_INSTANCE = hdmi_input_v_hdmi_rx_ss_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = vprocss
 PARAMETER DRIVER_VER = 2.5
 PARAMETER HW_INSTANCE = hdmi_input_v_proc_ss_scaler
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = v_hdmitxss
 PARAMETER DRIVER_VER = 5.2
 PARAMETER HW_INSTANCE = hdmi_output_v_hdmi_tx_ss_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = v_mix
 PARAMETER DRIVER_VER = 5.0
 PARAMETER HW_INSTANCE = hdmi_output_v_mix_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = mipicsiss
 PARAMETER DRIVER_VER = 1.2
 PARAMETER HW_INSTANCE = mipi_csi2_rx_mipi_csi2_rx_subsystem_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = v_demosaic
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = mipi_csi2_rx_v_demosaic_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = v_frmbuf_wr
 PARAMETER DRIVER_VER = 4.0
 PARAMETER HW_INSTANCE = mipi_csi2_rx_v_frmbuf_wr_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = v_gamma_lut
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = mipi_csi2_rx_v_gamma_lut_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = vprocss
 PARAMETER DRIVER_VER = 2.5
 PARAMETER HW_INSTANCE = mipi_csi2_rx_v_proc_ss_csc
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = vprocss
 PARAMETER DRIVER_VER = 2.5
 PARAMETER HW_INSTANCE = mipi_csi2_rx_v_proc_ss_scaler
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.0
 PARAMETER HW_INSTANCE = nv_small_64_v07_0
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = iic
 PARAMETER DRIVER_VER = 3.5
 PARAMETER HW_INSTANCE = sensor_iic
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = v_frmbuf_wr
 PARAMETER DRIVER_VER = 4.0
 PARAMETER HW_INSTANCE = tpg_input_v_frmbuf_wr_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = vtc
 PARAMETER DRIVER_VER = 8.0
 PARAMETER HW_INSTANCE = tpg_input_v_tc_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = v_tpg
 PARAMETER DRIVER_VER = 8.1
 PARAMETER HW_INSTANCE = tpg_input_v_tpg_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = vphy
 PARAMETER DRIVER_VER = 1.8
 PARAMETER HW_INSTANCE = vid_phy_controller_0
END
